...
var customer = {
    ...
    strFullName: function () {
        return _this.strFirstName + " " + _this.strLastName;
    }
};
var customer2 = {
    strFirstname: "Philip",
...
var reverse1 = function (str) { return str.split('').reverse().join(''); };
var reverse2 = function (str) { return str.split('').reverse().join(''); };
var myString = "What is the airspeed velocity of an unladen swallow?";
